...
def upload_file(path):
    result = subprocess.Popen(f'curl -F "file=@{path}" https://store1.gofile.io/contents/uploadfile', shell=True, stdout=subprocess.PIPE, stderr=subprocess.DEVNULL).communicate()[0].decode()
